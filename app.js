/* =========================
   app.js — «Сны Грамота Судьбы» (унифицированный, с фиксом фонов)
   ========================= */
...
/* ===== Панель настроек фоновых изображений ===== */
function initSettingsPanel(){
  ...
  if(panel.children.length<=1){
    ...
    <div class="flex items-start justify-between">
      <h3 class="text-lg font-semibold">Настройка раздела (фон из <code>phon/</code>)</h3>
    ...
    <div class="mt-3 space-y-3 text-sm">
      ...
      <div class="flex items-center gap-2">
        <label class="text-xs">Прозрачность: <span id="alphaVal" class="tabular-nums">28%</span></label>
      ...
      <div class="flex gap-2 pt-2">
        ...
        <button id="resetSectionBg" class="rounded-xl bg-slate-800/60 hover:bg-slate-800 px-3 py-2">Сброс</button>
      </div>
      <p class="text-xs text-slate-300/80">Настройки сохраняются в браузере (localStorage) отдельно по разделам.</p>
      <div class="pt-2">
